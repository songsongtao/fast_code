...
public class QMUIEmptyView extends FrameLayout {
    private LineRotateLoadingView mLoadingView;
    private TextView mTitleTextView;
    private TextView mDetailTextView;
    protected ButtonBgUi mButton;
    ...
    private void init() {
        ...
        mLoadingView = (LineRotateLoadingView)findViewById(R.id.empty_view_loading);
        mTitleTextView = (TextView)findViewById(R.id.empty_view_title);
        mDetailTextView = (TextView)findViewById(R.id.empty_view_detail);
        mButton = (ButtonBgUi) findViewById(R.id.empty_view_button);
