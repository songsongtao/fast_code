...
/**
 * description: This is ClearEditTextView 带删除和抖动的输入框
 * author: Administrator
 * date: 2017/11/28 9:03
 * update: 不能和setError()一起使用
 * version: 1.0
 */
public class ClearEditTextView extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        mClearDrawable = getResources().getDrawable(R.drawable.ic_et_del);
        //设置删除按钮的边界
