package com.song.shapebglib.permission;
...
/**
 * description: 6.0 运行时权限处理工具类,重点在于把系统的
 * author: https://github.com/Airsaid/MPermissionUtils
...
public class MPermissionUtils {
    ...
    private static void requestPermissions(Object object, int requestCode
        ...
        //检查是否是activity,fragment,不是抛出异常,中断
        checkCallingObjectSuitability(object);

        //设置回调接口
        mOnPermissionListener = callback;

        //检查是否已近获得权限,或是6.0以下不需要权限
